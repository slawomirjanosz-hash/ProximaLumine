...
class User extends Authenticatable implements FilamentUser
{
    ...
    protected $fillable = [
        ...
        'can_import_project_costs_excel',
        'can_view_offers',
        'can_view_recipes',
        'can_view_catalog',
        'can_add',
    ...
    protected function casts(): array
    {
        return [
            ...
            'can_projects_add' => 'boolean',
            'can_projects_in_progress' => 'boolean',
            'can_projects_warranty' => 'boolean',
            'can_projects_archived' => 'boolean',
            'can_projects_settings' => 'boolean',
            'can_import_project_costs_excel' => 'boolean',
    ...
    {
        return (bool) ($this->is_admin || $this->can_settings_users || $this->can_settings);
    }
}
