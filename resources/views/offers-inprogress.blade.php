                            ...
                            <tr class="border-t hover:bg-gray-50">
                                ...
                                <td class="p-2 text-center">
                                    <div class="flex gap-1 justify-center flex-nowrap">
                                        ...
                                        <a href="{{ route('offers.htmlPreview', $offer) }}" target="_blank" title="Podgląd HTML / Drukuj PDF" class="p-1.5 bg-emerald-600 text-white rounded hover:bg-emerald-700 inline-flex items-center">
