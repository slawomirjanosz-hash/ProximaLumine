...
Route::middleware(['auth', 'permission:view_offers'])->post('/wyceny/nowa', function (Illuminate\Http\Request $request) {
    ...
    \App\Models\Offer::create([
        ...
        'schedule_enabled' => $request->input('schedule_enabled') === '1',
        'schedule' => array_values($request->input('schedule', [])),
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/parts/bulk-remove', [PartController::class, 'bulkRemove'])->name('magazyn.parts.bulkRemove')->middleware('permission:remove');
    ...
    Route::post('/projekty/{project}/autoryzuj', [PartController::class, 'processAuthorization'])->name('magazyn.projects.authorize.process')->middleware('auth');
    Route::get('/projekty/{project}/edit', [PartController::class, 'editProject'])->name('magazyn.editProject')->middleware('auth');
    Route::put('/projekty/{project}', [PartController::class, 'updateProject'])->name('magazyn.updateProject')->middleware('auth');
